...
class TrajectoryOptimizer:
    def __init__(self):
        ...
        self.z_b_dot_i = 500  # initial z-velocity [uu/s]
        ...
        self.col_cf_w = (
            1e-1  # weight of the error of the head on collision(to be fixed)
        )
...
if __name__ == "__main__":
    ...
    print(to.sol.value(to.b[:2, -1]))
    print(to.sol.value(to.q[:2, -1]))
